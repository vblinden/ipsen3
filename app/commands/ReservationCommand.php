...
class ReservationCommand extends Command {
	 ...
	 * @var string
	 */
	protected $name = 'command:reservation';
	 ...
	 * @var string
	 */
	protected $description = 'Checks if there are reservations that needs to be deleted and if there are users that need an review email.';
